  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 relative overflow-hidden",
          side === "right" &&
      ...
      >
        ...
        {(side === "left" || side === "right") && (
          <div className={cn(
            "absolute top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-primary/20 to-transparent",
...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1.5 p-4 relative", className)}
      {...props}
    >
